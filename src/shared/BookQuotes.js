export const BookQuotes = [
    ...
    {
        id: 12,
        quote: "No man can be called friendless who has God and the companionship of good books.",
        author: "Elizabeth Barrett Browning"
    },
    {
        id: 13,
        quote: "Some of these things are true and some of them lies. But they are all good stories.",
        author: "Hilary Mantel, Wolf Hall"
    },
    {
        id: 14,
    ...
    {
        id: 17,
        quote: "Books are not made for furniture, but there is nothing else that so beautifully furnishes a house.",
